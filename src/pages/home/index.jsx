...
const HomePage = () => {
  ...
  const [messages, setMessages] = useState(() => {
    ...
    const userinfo_local = JSON.parse(localStorage.getItem("messages")) || {};
    if (user && !userinfo_local[user]) {
      userinfo_local[user] = [];
      localStorage.setItem("messages", JSON.stringify(userinfo_local));
    }
    return user ? userinfo_local[user] : [];
  });
